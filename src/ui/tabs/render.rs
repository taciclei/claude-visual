        ...
        div()
            ...
            .child(
                div()
                    ...
                    .gap_px()
                    .px_1()
                    .children(tab_data.into_iter().map(|(idx, title, is_dirty, is_pinned, is_active)| {
                        let bg = if is_active {
                ...
                this.on_drag(
                            ...
                            .on_drop(cx.listener(move |this, _: &DraggedTab, _window, cx| {
                            ...
                            .child(
                                div()
                                    ...
                                    .when(is_pinned, |this| {
                                        ...
                                        this.hover(|style| style.bg(theme.colors.accent.opacity(0.2)))
                                    })
                                    .when(!is_pinned, |this| {
                                        // Unpinned tabs show close button
                                        this.hover(|style| style.bg(theme.colors.error.opacity(0.2)))
                                    })
                                    .cursor_pointer()
                                    .text_xs()
