...
pub(super) enum ToolDisplay {
    FilePath { path: String, display: String },
    Command { cmd: String, desc: String, display: String },
    Pattern { pattern: String, path: Option<String>, display: String },
    Prompt { display: String },
    Edit { file_path: String, old_text: Option<String>, new_text: Option<String> },
    Json(String),
    Plain(String),
}
