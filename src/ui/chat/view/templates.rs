...
use super::types::{NotificationType, PromptTemplate};
use gpui::*;
...
impl ChatView {
    ...
    pub fn templates_by_category(
        &self,
    ) -> std::collections::HashMap<&'static str, Vec<&PromptTemplate>> {
        let mut groups: std::collections::HashMap<&'static str, Vec<&PromptTemplate>> =
