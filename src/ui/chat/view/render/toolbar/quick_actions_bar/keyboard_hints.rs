...
impl ChatView {
    pub(super) fn render_keyboard_hints(&self, theme: &crate::app::theme::Theme) -> impl IntoElement {
        let hints = [
            ("⌘K", "palette"),
            ("/", "skills"),
            ("@", "files"),
    ...
    pub(super) fn render_recent_commands(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            .when(!self.recent_commands.is_empty(), |d| {
                d.child(
                    div()
                        .w(px(1.0))
                        .h(px(12.0))
                ...
                .child(
                    div()
                        ...
                        .children(self.recent_commands.iter().take(3).enumerate().map(|(idx, cmd)| {
