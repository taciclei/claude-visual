...
impl ChatView {
    ...
    pub fn render_session_health_indicator(
        &self,
        ...
        div()
            ...
            // Health icon
            .child(div().text_xs().child(if self.stats.health > 0.8 {
                "💚"
            ...
            // Health label
            .child(div().text_xs().text_color(health_color).child(health_label))
    }

    pub fn render_onboarding_tip(
        &self,
        tip_id: &'static str,
        icon: &'static str,
