                    ...
                    .map(|(i, notification)| {
                        let (bg_color, border_color, icon) = match notification.notification_type {
                            ...
                            NotificationType::Info => {
                                (theme.colors.info.opacity(0.1), theme.colors.info, "ℹ")
                            }
                            NotificationType::Warning => {
                                (theme.colors.warning.opacity(0.1), theme.colors.warning, "⚠")
                            }
                            NotificationType::Error => {
                                (theme.colors.error.opacity(0.1), theme.colors.error, "✕")
                            }
                        };
                        ...
                        let mut result = div()
                            ...
                            .child(
                                div()
                                    ...
                                    .items_center()
                                    .gap_2()
                                    .child(div().text_sm().text_color(border_color).child(icon))
                                    .child(
                                        div()
                                            .flex_1()
                                            .text_sm()
