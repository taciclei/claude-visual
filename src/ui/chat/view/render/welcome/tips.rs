...
impl ChatView {
    pub fn render_welcome_tips(&self, theme: &Theme, cx: &mut Context<Self>) -> Div {
        ...
        tips.push((
            ...
            "⌨️",
            "Keyboard shortcuts",
            "Press ⌘? for all shortcuts, Ctrl+L clears, Ctrl+R searches history",
        ));
        ...
        if self.git_info.is_some() {
            tips.push((
                ...
                "📦",
                "Git workflows",
                "Use /commit, /create-pr, /merge for smart git operations",
            ));
            tips.push((
                "tip-review",
                "👀",
                "Code review",
                "Use /review for expert code review with security analysis",
            ));
        }
        ...
        tips.push((
            ...
            "⚡",
            "Claude Code Skills",
            "Type / to see all skills: /apex, /brainstorm, /explore, /debug, /oneshot",
        ));
        tips.push((
            "tip-mention",
            "@",
            "File mentions",
            "Type @ to reference files in your prompts for context-aware help",
        ));
        tips.push((
            "tip-ultrathink",
            "🧠",
            "Deep thinking",
            "Use /ultrathink for craftsman-level analysis and elegant solutions",
        ));
        ...
        if let Some(ref info) = self.session_info {
            if !info.mcp_servers.is_empty() {
                ...
                tips.push((
                    ...
                    "MCP Connected",
                    if tool_count > 0 {
                        "External tools available! Click MCP button to explore"
                    } else {
                        "MCP servers connected. Use their capabilities in your prompts"
                    },
                ));
            }
        }
        ...
        tips.push((
            ...
            "⚡",
            "APEX methodology",
            "Use /apex for systematic Analyze-Plan-Execute-eXamine workflow",
        ));
        tips.push((
            "tip-explore",
            "🔍",
            "Codebase exploration",
            "Use /explore to understand code, /search for quick answers",
        ));
        tips.push((
            "tip-brainstorm",
            "💡",
            "Research mode",
            "Use /brainstorm for deep research with multiple perspectives",
        ));
        tips.push((
            "tip-memory",
            "💾",
        ...
        tips.push((
            ...
            "📖",
            "Documentation",
            "Use /docs for documentation research, /explain for code explanations",
        ));
                    ...
                    .map(|(tip_id, icon, title, description)| {
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    .id(ElementId::Name(
                                        format!("dismiss-welcome-tip-{}", tip_id).into(),
                                    ))
                                    .w(px(24.0))
                                    .h(px(24.0))
                                    .flex()
