...
impl ChatView {
    pub fn render_quick_reply_suggestions(
        &self,
    ...
    pub fn render_contextual_quick_actions(
        &self,
        theme: &crate::app::theme::Theme,
        cx: &mut Context<Self>,
    ) -> Div {
        ...
        div()
            ...
            // Actions
            .children(actions.into_iter().map(|(icon, label, action)| {
    ...
    pub fn render_contextual_hints(&self, theme: &crate::app::theme::Theme) -> Div {
        ...
        div()
            ...
            .children(hints.into_iter().map(|(shortcut, label)| {
                    ...
                    .child(
                        div()
                            .text_color(if is_urgent {
                                ...
                                theme.colors.text_muted.opacity(0.7)
                            })
                            .child(label),
                    )
            }))
