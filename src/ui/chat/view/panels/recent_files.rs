...
impl ChatView {
    pub fn render_recent_files_panel(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
                                    ...
                                    div()
                                        ...
                                        .child(
                                            div()
                                                ...
                                                .child(
                                                    div()
                                                        .id(ElementId::Name(format!("add-ctx-{}", idx).into()))
                                                        .px_2()
                                                        .py_1()
                                                        .rounded_md()
                                                        .cursor_pointer()
                                                        ...
                                                        .on_click(cx.listener(move |this, _, _window, cx| {
                                                            this.add_context_file(file_path_ctx.clone(), cx);
                                                        }))
                                                        .child("+ctx")
                                                )
                                                .child(
                                                    div()
                                                        .id(ElementId::Name(format!("mention-{}", idx).into()))
                                                        .px_2()
                                                        .py_1()
                                                        .rounded_md()
                                                        .cursor_pointer()
                                                        ...
                                                        .on_click(cx.listener(move |this, _, _window, cx| {
                                                            this.insert_file_mention(&file_path, cx);
                                                            this.toggle_recent_files_panel(cx);
                                                        }))
                                                        .child("@mention")
                                                )
                                                ...
                                                .child(
                                                    div()
                                                        .id(ElementId::Name(format!("explain-{}", idx).into()))
                                                        .flex()
                                                        .items_center()
                                                        .gap_1()
                                                        .px_2()
                                                        ...
                                                        .on_click(cx.listener(move |this, _, _window, cx| {
                                                            this.toggle_recent_files_panel(cx);
                                                            let prompt = format!("/explain @file:{}", file_path_explain);
                                                ...
                                                .child(
                                                    div()
                                                        .id(ElementId::Name(format!("review-{}", idx).into()))
                                                        .flex()
                                                        .items_center()
                                                        .gap_1()
                                                        .px_2()
                                                        ...
                                                        .on_click(cx.listener(move |this, _, _window, cx| {
                                                            this.toggle_recent_files_panel(cx);
                                                            let prompt = format!("/review @file:{}", file_path_review);
                                                            cx.emit(ChatViewEvent::Submit(prompt));
                                                        }))
                                                        .child("👀")
                                                        .child("Review")
    ...
    fn render_empty_files_state(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            .p_8()
            .flex()
            .flex_col()
            ...
            .child(
                div()
                    ...
                    .on_click(cx.listener(|this, _, _window, cx| {
                        this.toggle_recent_files_panel(cx);
                        cx.emit(ChatViewEvent::Submit("/explore What are the main files in this codebase?".to_string()));
                    }))
                    .child("🔍")
    ...
    fn render_file_skills_footer(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            .px_4()
            .py_2()
            .border_t_1()
