...
impl ChatView {
    pub fn render_quick_settings_panel(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
        div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            // Show Timestamps
                            .child(self.render_setting_toggle("Show Timestamps", "Display message timestamps", self.show_timestamps, "toggle_timestamps", &theme, cx))
                            // Time Separators
                            .child(self.render_setting_toggle("Time Separators", "Show date separators between messages", self.show_time_separators, "toggle_time_separators", &theme, cx))
                            // Compact Mode
                            .child(self.render_setting_toggle("Compact Mode", "Reduce message spacing", self.compact_mode, "toggle_compact", &theme, cx))
                            // Line Numbers
                            .child(self.render_setting_toggle("Line Numbers", "Show line numbers in code", self.show_line_numbers, "toggle_line_numbers", &theme, cx))
                            // Word Wrap
                            .child(self.render_setting_toggle("Word Wrap", "Wrap long lines in code", self.word_wrap, "toggle_word_wrap", &theme, cx))
                            // Behavior section
                            .child(
                                div()
                                    .px_3()
                            ...
                            // Auto-scroll
                            .child(self.render_setting_toggle("Auto-scroll", "Scroll to new messages", self.auto_scroll, "toggle_auto_scroll", &theme, cx))
                            // Show Suggestions
                            .child(self.render_setting_toggle("Suggestions", "Show contextual suggestions", self.panels.suggestions, "toggle_suggestions", &theme, cx))
                            // Focus Mode
                            .child(self.render_setting_toggle("Focus Mode", "Distraction-free input", self.focus_mode, "toggle_focus", &theme, cx))
                            // Input Hints
                            .child(self.render_setting_toggle("Input Hints", "Show input suggestions", self.show_input_hints, "toggle_hints", &theme, cx))
                            // Claude section
                            .child(
                                div()
                                    .px_3()
                            ...
                            // Show Thinking
                            .child(self.render_setting_toggle("Show Thinking", "Display Claude's reasoning process", self.show_thinking, "toggle_thinking", &theme, cx))
    ...
    fn render_quick_skill_buttons(&self, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub fn render_setting_toggle(&self, label: &str, description: &str, is_on: bool, action: &'static str, theme: &crate::app::theme::Theme, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            ...
            .child(
                div()
                    ...
                    .h(px(22.0))
                    .rounded_full()
                    .bg(if is_on { theme.colors.accent } else { theme.colors.surface_hover })
                    .border_1()
                    .border_color(if is_on { theme.colors.accent } else { theme.colors.border })
                    .flex()
                    .items_center()
                    .child(
                        div()
