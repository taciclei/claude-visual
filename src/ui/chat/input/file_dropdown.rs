...
impl ChatInput {
    ...
    pub(super) fn render_file_dropdown(&self, theme: &Theme, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            // File list
            .children(
                self.filtered_files.iter().enumerate().map(|(i, file_match)| {
                    ...
                    div()
                        ...
                        .on_click(cx.listener(move |this, _, _window, cx| {
                            ...
                            if let Some(idx) = this.filtered_files.iter().position(|f| f.path == path_clone) {
                            ...
                            div()
                                ...
                                .child(
                                    div()
                                        ...
                                        .text_sm()
                                        .children(
                                            render_highlighted_filename(&display, &matched_indices, accent, text_color)
                                        )
                                )
                                // Full path (muted)
...
fn render_highlighted_filename(name: &str, matched_indices: &[usize], accent: gpui::Hsla, text_color: gpui::Hsla) -> Vec<Div> {
