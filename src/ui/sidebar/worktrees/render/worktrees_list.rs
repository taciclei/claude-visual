...
pub(crate) fn render_worktrees_list(
    ...
    div()
        ...
        .children(worktree_items.into_iter().map(|(idx, branch, _path, is_main, is_locked, is_selected)| {
                ...
                .when(has_context_menu, |d| {
                    d.child(
                        div()
                            ...
                            .child(
                                div()
                                    .id(ElementId::Name(format!("wt-copy-branch-{}", idx).into()))
                                    .px_2()
                                    .py_1()
                                    .rounded_sm()
                                    .cursor_pointer()
                            ...
                            .when(!is_main, |d| {
                                d.child(
                                    div()
                                        .id(ElementId::Name(format!("wt-delete-{}", idx).into()))
                                        .px_2()
                                        .py_1()
                                        .rounded_sm()
                                        .cursor_pointer()
