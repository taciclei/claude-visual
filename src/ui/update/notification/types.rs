//! Type definitions for update notifications

use gpui::*;

/// Color scheme for the update notification UI
...
pub(crate) fn default_colors() -> SimpleColors {
    SimpleColors {
        ...
        accent_hover: hsla(210.0 / 360.0, 0.80, 0.50, 1.0),
    }
}

/// Events emitted by the update notification
#[derive(Debug, Clone)]
pub enum UpdateNotificationEvent {
    ...
    SkipVersion(String),
    /// User clicked to view release notes
    ViewReleaseNotes,
