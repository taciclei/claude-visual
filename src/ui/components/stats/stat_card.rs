...
impl StatCard {
    pub fn new(app_state: Arc<AppState>, label: impl Into<String>, value: impl Into<String>, _cx: &mut Context<Self>) -> Self {
        Self {
            app_state,
            label: label.into(),
            value: value.into(),
    ...
    /// Set trend
    pub fn set_trend(&mut self, direction: TrendDirection, value: Option<String>, cx: &mut Context<Self>) {
...
impl Render for StatCard {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let trend_color = match self.trend {
            ...
            TrendDirection::Up => if self.trend_up_is_good { success } else { error },
            TrendDirection::Down => if self.trend_up_is_good { error } else { success },
        };
        ...
        div()
            ...
            // Trend
            .when_some(if self.trend != TrendDirection::Neutral || self.trend_value.is_some() {
