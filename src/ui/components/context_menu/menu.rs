        ...
        div()
            ...
            .children(self.items.into_iter().map(|item| {
                match item.item_type {
                    ContextMenuItemType::Separator => div()
                        .w_full()
                        .h(px(1.0))
                        .my_1()
                        .bg(border)
                    ...
                    _ => {
                        let is_checkbox =
                            matches!(item.item_type, ContextMenuItemType::Checkbox(_));
                        ...
                        let mut row = div().w_full().px_3().py_2().flex().items_center().gap_3();
                        ...
                        if is_submenu {
                            row = row.child(div().text_xs().text_color(text_muted).child("›"));
